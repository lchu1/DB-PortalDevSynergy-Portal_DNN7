...
[PaymentProcessor] [nvarchar] (50) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
[ProcessorUserId] [nvarchar] (50) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
[ProcessorPassword] [nvarchar] (100) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
[SiteLogHistory] [int] NULL,
[DefaultLanguage] [nvarchar] (10) COLLATE SQL_Latin1_General_CP1_CI_AS NOT NULL CONSTRAINT [DF_Portals_DefaultLanguage] DEFAULT ('en-US'),
[TimezoneOffset] [int] NOT NULL CONSTRAINT [DF_Portals_TimezoneOffset] DEFAULT ((-8)),
[HomeDirectory] [varchar] (100) COLLATE SQL_Latin1_General_CP1_CI_AS NOT NULL CONSTRAINT [DF_Portals_HomeDirectory] DEFAULT (''),

...
[ParentId] [int] NULL,
[Order] [int] NOT NULL CONSTRAINT [DF__PersonaBa__Order__4DB54E83] DEFAULT ((0)),
[AllowHost] [bit] NOT NULL CONSTRAINT [DF__PersonaBa__Allow__4EA972BC] DEFAULT ((0)),
[Enabled] [bit] NOT NULL CONSTRAINT [DF__PersonaBa__Enabl__4F9D96F5] DEFAULT ((0)),

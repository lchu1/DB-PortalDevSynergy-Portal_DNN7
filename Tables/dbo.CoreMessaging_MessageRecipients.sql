...
[SendToast] [bit] NOT NULL CONSTRAINT [DF__CoreMessa__SendT__5654B625] DEFAULT ((0))
) ON [PRIMARY]
GO
...
GO
CREATE UNIQUE NONCLUSTERED INDEX [IX_CoreMessaging_MessageRecipients_UserID_MessageID_Read_SendToast] ON [dbo].[CoreMessaging_MessageRecipients] ([MessageID], [UserID], [Read], [SendToast]) ON [PRIMARY]
GO

...
GO
CREATE UNIQUE NONCLUSTERED INDEX [IX_UserRoles_RoleID_UserID] ON [dbo].[UserRoles] ([RoleID], [UserID]) INCLUDE ([CreatedByUserID], [CreatedOnDate], [EffectiveDate], [ExpiryDate], [IsOwner], [IsTrialUsed], [LastModifiedByUserID], [LastModifiedOnDate], [Status], [UserRoleID]) ON [PRIMARY]
GO

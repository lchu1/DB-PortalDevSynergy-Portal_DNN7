...
[IsSystem] [bit] NOT NULL CONSTRAINT [DF__ContentWo__IsSys__7E038023] DEFAULT ((0)),
[WorkflowKey] [nvarchar] (40) COLLATE SQL_Latin1_General_CP1_CI_AS NOT NULL CONSTRAINT [DF__ContentWo__Workf__02C83540] DEFAULT (N'')
) ON [PRIMARY]
GO

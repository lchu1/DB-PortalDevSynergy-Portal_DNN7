...
GO
CREATE NONCLUSTERED INDEX [IX_Modules_ModuleDefId] ON [dbo].[Modules] ([ModuleDefID], [ModuleID]) INCLUDE ([AllTabs], [CreatedByUserID], [CreatedOnDate], [EndDate], [InheritViewPermissions], [IsShareable], [IsShareableViewOnly], [LastContentModifiedOnDate], [LastModifiedByUserID], [LastModifiedOnDate], [PortalID], [StartDate]) ON [PRIMARY]
GO

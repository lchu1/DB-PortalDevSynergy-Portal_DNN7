...
CREATE VIEW [dbo].[_CHCN_Company_V]
AS
SELECT     dbo.UserProfile.UserID, dbo.ProfilePropertyDefinition.PropertyCategory, dbo.ProfilePropertyDefinition.PropertyName AS Company, 
...
WHERE     (dbo.ProfilePropertyDefinition.PropertyCategory = N'Company')
